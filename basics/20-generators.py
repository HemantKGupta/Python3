# We will generate the cubes of (1-10) using a simple generator function of our own,
#  and using a python generator which uses the Yield keyword for lazy evaluation
def cube(n):
    return n ** 3
